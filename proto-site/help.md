...
Hint: Στο τέλος μην ξεχάσετε να διαγράψετε από το μενού (`navigation.md`) την παρούσα σελίδα (~~`[Βοήθεια για το site](help.md)`~~).
...
*Παράδειγμα:* `Πατήστε εδώ για να πάτε στη [Google](http://google.com)` δίνει:
Πατήστε εδώ για να πάτε στη [Google](http://google.com)

Ειδικά για τις σελίδες αυτού του site βάλτε σκέτο το αρχείο `.md`
*Παράδειγμα:* `[Επικοινωνήστε μαζί μας](επικοινωνία.md)` δίνει:
